package com.example.barberking.Marcação.Asgard.B2D
...
import kotlinx.android.synthetic.main.activity_d1_b2.*

class D1B2 : AppCompatActivity() {
    private val dbFirestore: DocumentReference =
        FirebaseFirestore.getInstance().collection("Agendamento")
            .document("Asgard").collection("Barbeiro2").document("Fevereiro").collection("Dias")
            .document("1")

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_d1_b2)
    ...
    fun onClick(view: View) {
        when (view.id) {
            ...
            R.id.h1011 -> {
                ...
                val view = layoutInflater.inflate(R.layout.confirmar2, null)
