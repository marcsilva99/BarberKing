...
import kotlinx.android.synthetic.main.activity_d3_b3.*

class D3B3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_d3_b3)
        ...
        when (view.id) {
            ...
            R.id.h1011 -> {
                ...
                builder.setPositiveButton("Confirmar", DialogInterface.OnClickListener { _, _ ->
                    ...
                    dbFirestore.collection("10:00 11:00").document("10:00 11:00")
            ...
            R.id.h1112 -> {
                ...
                builder.setPositiveButton("Confirmar", DialogInterface.OnClickListener { _, _ ->
                    ...
                    dbFirestore.collection("11:00 12:00").document("11:00 12:00")
                        .set(data, SetOptions.merge())
            ...
            R.id.h1415 -> {
                ...
                builder.setPositiveButton("Confirmar", DialogInterface.OnClickListener { _, _ ->
                    ...
                    dbFirestore.collection("14:00 15:00").document("14:00 15:00")
                        .set(data, SetOptions.merge())
            ...
            R.id.h1516 -> {
                ...
                builder.setPositiveButton("Confirmar", DialogInterface.OnClickListener { _, _ ->
                    ...
                    dbFirestore.collection("15:00 16:00").document("15:00 16:00")
                        .set(data, SetOptions.merge())
            ...
            R.id.h1617 -> {
                ...
                builder.setPositiveButton("Confirmar", DialogInterface.OnClickListener { _, _ ->
                    ...
                    dbFirestore.collection("16:00 17:00").document("16:00 17:00")
                        .set(data, SetOptions.merge())
