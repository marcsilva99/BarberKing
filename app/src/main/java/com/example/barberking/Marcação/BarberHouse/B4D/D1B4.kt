package com.example.barberking.Marcação.BarberHouse.B4D
...
import kotlinx.android.synthetic.main.activity_d1_b4.*

class D1B4 : AppCompatActivity() {
    private val dbFirestore: DocumentReference =
        FirebaseFirestore.getInstance().collection("Agendamento")
            .document("BarberHouse").collection("Barbeiro4").document("Fevereiro").collection("Dias")
            .document("1")

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_d1_b4)
