...
import com.example.barberking.Marcação.Asgard.Barbeiro2Activity
...
class BarberHouseActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_barber_house)
            ...
            val barbeiro3 = findViewById(R.id.barberbarb3) as TextView
            barbeiro3.setOnClickListener {
                val intent = Intent(this, Barbeiro3Activity::class.java)
                startActivity(intent)
            }

            val barbeiro4 = findViewById(R.id.barberbarb4) as TextView
